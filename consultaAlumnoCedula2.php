...
<table width="485" align="center" cellpadding="3">
  ...
  <tr valign="baseline">
    <td colspan="2" align="right" nowrap="nowrap" bgcolor="#FF0000"><div align="center" class="Estilo67">Datos de Estudiante </div></td>
  </tr>
  <tr valign="baseline">
  ...
  <tr valign="baseline">
    <td colspan="2" align="right" nowrap="nowrap"><div align="left">Repitiente:<?php echo $row_alumno['repitiente']; ?>&nbsp;      &nbsp;&nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp;Calificacion Obtenida:
      
      <?php echo $row_alumno['calificacion']; ?></div></td>
  </tr>
  <tr valign="baseline">
  ...
  <tr valign="baseline">
    <td colspan="2" align="right" nowrap="nowrap" bgcolor="#FF0000"><div align="center" class="Estilo67">Ingrese los Datos del Padre </div></td>
  </tr>
  <tr valign="baseline">
  ...
  <tr valign="baseline">
    <td colspan="2" align="right" nowrap="nowrap" bgcolor="#FF0000"><div align="center" class="Estilo67">Ingrese los Datos de la Madre </div></td>
  </tr>
  <tr valign="baseline">
  ...
  <tr valign="baseline">
    <td colspan="2" align="right" nowrap="nowrap" bgcolor="#FF0000"><div align="center"><span class="Estilo67">Ingrese los Datos del Representante Legal </span></div></td>
  </tr>
  <tr valign="baseline">
  ...
  <tr valign="baseline">
    <td colspan="2" align="right" nowrap="nowrap" bgcolor="#FF0000"><div align="center"><span class="Estilo7 Estilo67">Situacion de la Pareja </span></div></td>
  </tr>
  <tr valign="baseline">
  ...
  <tr valign="baseline">
    <td colspan="2" align="right" nowrap="nowrap" bgcolor="#FF0000"><div align="center"><span class="Estilo67">Ubicacion de la Vivienda </span></div></td>
  </tr>
  <tr valign="baseline">
    <td colspan="2" align="right" nowrap="nowrap"><div align="center"><?php echo $row_alumno['zonav']; ?></div></td>
  </tr>
  <tr valign="baseline">
    <td colspan="2" align="right" nowrap="nowrap" bgcolor="#FF0000"><div align="center"><span class="Estilo67">Aspectos Medicos</span></div></td>
  </tr>
  <tr valign="baseline">
  ...
  <tr valign="baseline">
    <td colspan="2" align="right" nowrap="nowrap" bgcolor="#FF0000"><table width="273" height="23" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <th width="47" height="21" scope="col"> <label> <? echo "<a href='principal.php?id=$row_alumno[id]&link=link113&link2=link1116'> <input type=submit name=Submit22  class='Estilo4' value=Modificar /></a>";?> </label></th>
        ...
        <th width="62" scope="col"> <label> <? echo "<a onClick='return validar()' href='principal.php?id=$row_alumno[id]&cedula=$row_alumno[cedula]&link=link115&link2=link1116'><input type=submit name=Submit2 class='Estilo4' value=Elinimar /></a>"; ?> </label></th>
      </tr>
    </table></td>
  </tr>
</table>
