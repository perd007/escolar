...
<table width="596" border="0" cellpadding="0" cellspacing="0">
  <tr bgcolor="#00CCFF">
    <th colspan="9" bgcolor="#b50f0f" ><span class="Estilo1"><strong>Usuarios</strong></span></th>
  </tr>
  <tr>
  ...
  <tr bgcolor="#00CCFF">
    <td width="111" bgcolor="#b50f0f"><span class="Estilo3">Usuario</span></td>
    <td width="99" bgcolor="#b50f0f"><span class="Estilo3">Clave</span></td>
    <td width="66" bgcolor="#b50f0f"><span class="Estilo3">Modificar</span></td>
    <td width="56" bgcolor="#b50f0f"><span class="Estilo3">Eliminar</span></td>
    <td width="64" bgcolor="#b50f0f"><span class="Estilo3">Registrar</span></td>
    <td width="65" bgcolor="#b50f0f"><span class="Estilo3">Consultar</span></td>
    <td width="79" bgcolor="#b50f0f"><span class="Estilo3">Administrar</span></td>
    <td width="28" bgcolor="#b50f0f"><span class="Estilo3">Op1</span></td>
    <td width="28" bgcolor="#b50f0f"><span class="Estilo3">Op2</span></td>
  </tr>
  <?php do { 
...
$a="no";
  ...
  <tr bgcolor="<?php echo $color; ?>">
      ...
      <td><span class="Estilo4"><?php echo "<a href='Principal.php?link=link72&cod=$row_usuarios[id_seg]'>Modificar</a>"; ?></span></td>
      <td><span class="Estilo4"><?php echo "<a onClick='return validar()' href='Principal.php?link=link73&id=$row_usuarios[id_seg]'>Eliminar</a>"; ?></span></td>
