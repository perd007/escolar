...
echo "<script type=\"text/javascript\">alert ('Usuario ya Registrado'); location.href='principal.php?link=link72&cod=$_GET[cod]' </script>";
 exit;
  ...
  if($Result1){
  echo "<script type=\"text/javascript\">alert ('Datos Guardados');  location.href='Principal.php?link=link71' </script>";
  }else{
...
<form method="post" name="form1" onSubmit="return validar()" action="<?php echo $editFormAction; ?>">
  <table align="center">
    ...
    <tr valign="baseline">
      <td colspan="2" align="right" nowrap><div align="center">Permisos</div></td>
    </tr>
    <tr valign="baseline">
