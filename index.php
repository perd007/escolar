                              ...
                              <tr>
                                <td colspan="2"><map name="Map" id="Map">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="98%">
                                      <tbody>
                                        <tr valign="top">
                                          <td width="720" height="62" valign="top"><div align="center"><img src="imagenes/gobierno.gif" width="755" height="62" />
                                    ...
                                    <table border="0" width="100%" cellpadding="0" cellspacing="0">
								  	...
								  	<a href="http://renadit.me.gob.ve" class="bar" target="blank">Renadit</a>
								 		...
								 		<a href="contenido.php?id_seccion=29" class="bar">Más enlaces...</a>
                                          ...
                                          <td height="19" bgcolor="#FF0000" class="barra">&nbsp;</td>
                                          <td width="50" bgcolor="#FF0000" class="barra"></td>
                                          <td align="right" bgcolor="#FF0000" class="barra">&nbsp;</td>
                                        </tr>
                                      </tbody>
                                  </table>
                                ...
                                <td width="574" style="padding-top:5px;"><!-- Columna de Contenido Central -->
                                  ...
                                  <form id="form1" name="form1" onsubmit="return validar()" method="post" action="<?php echo $editFormAction; ?>">
                                    ...
                                    <table width="41%" border="1" align="center" bgcolor="#000000">
                                        <tr bgcolor="#CCCCCC">
                                          <th colspan="2" bgcolor="#FF0000" scope="col"><span class="Estilo1">Ingreso al Sistema</span> </th>
                                        </tr>
                                        <tr bgcolor="#CCCCCC">
                                          <td width="33%" bgcolor="#FF0000"><div align="right" class="Estilo1"><strong><em>Usuario:</em></strong></div></td>
                                          <td width="67%" bgcolor="#FF0000"><label>
                                            <input name="usuario" type="text" id="usuario" maxlength="10" />
                                          </label></td>
                                        </tr>
                                        <tr bgcolor="#CCCCCC">
                                          <td bgcolor="#FF0000"><div align="right" class="Estilo1"><strong><em>Clave:</em></strong></div></td>
                                          <td bgcolor="#FF0000"><input name="clave" type="password" id="clave" maxlength="10" /></td>
                                        </tr>
                                        <tr bgcolor="#CCCCCC">
                                          <td height="28" colspan="2" bgcolor="#FF0000"><div align="center">
                                              <input name="Submit2" type="submit" class="Estilo2" value="ENTRAR" />
                                          </div></td>
                                        </tr>
                                    </table>
                                    <p>
