                        ...
                        <tr>
                          <td height="447"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tbody>
                                <tr>
                                  <td colspan="3"><map name="Map">
                                      ...
                                      <table border="0" cellpadding="0" cellspacing="0" width="97%">
                                        <tbody>
                                          <tr>
                                            <td width="720"><div align="center"><img src="imagenes/gobierno.gif" width="752" height="58"  border="0" />
                                  ...
                                  <td colspan="3"><!-- Columna de Contenido Izquierda -->
								  	...
								  	<a href="http://renadit.me.gob.ve" class="bar" target="blank">Renadit</a>
								 		...
								 		<a href="contenido.php?id_seccion=29" class="bar">Más enlaces...</a>
                                            ...
                                            <td bgcolor="#FF0000" class="barra Estilo2">&nbsp;</td>
                                            <td width="50" bgcolor="#FF0000" class="barra Estilo2"></td>
                                            <td align="right" bgcolor="#FF0000" class="barra Estilo2">&nbsp;</td>
                                          </tr>
                                        </tbody>
                                      </table>
                                ...
                                <tr>
                                  <td width="160" height="366" valign="top"><!-- Columna de Contenido Izquierda -->
                                      <table border="0" bgcolor="#FFFFFF" width="160" cellpadding="0" cellspacing="0">
                                        <tbody>
                                          <tr>
                                          ...
                                          <tr>
                                            <td bgcolor="#FF0000"><table border="0" width="100%" cellpadding="0" cellspacing="0" class="boxcolor">
                                                <tbody>
                                                  <tr>
                                          ...
                                          <tr>
                                            <td bgcolor="#FF0000"><table border="0" class="boxcolor" width="94%" cellpadding="0" cellspacing="0">
                                                <tbody>
                                                  <tr>
                                                    <td height="5"></td>
                                                  </tr>
                                                  <tr>
                                                    <td><!-- Menu Izquierda -->
                                                        <table border="0" width="99%" cellpadding="0" cellspacing="0">
                                                          <tbody>
                                                            <tr>
                                                              <td bgcolor="#FF0000" class="navenlace"><a href="Principal.php?link=link1" name="link4"  class="Estilo3" id="link3" >Registro de Alumnos </a></td>
                                                            </tr>
                                                            
                                                            
                                                            <tr>
                                                              <td bgcolor="#FF0000" class="navenlace"><a href="principal.php?link=link1115" name="link9" class="Estilo3">Consulta de Alumnos </a></td>
                                                            </tr>
                                                            <tr>
                                                              <td bgcolor="#FF0000" class="navenlace"><a href="Principal.php?link=link5" name="link7" class="Estilo3">Registro de Docentes </a></td>
                                                            </tr>
                                                            <tr>
                                                              <td bgcolor="#FF0000" class="navenlace"><a href="#" name="link6" class="Estilo3">Consulta de Docentes </a></td>
                                                            </tr>
                                                            <tr>
                                                              <td bgcolor="#FF0000" class="navenlace"><a href="#" name="link11" class="Estilo3">Registro de Suplentes </a></td>
                                                            </tr>
                                                            <tr>
                                                              <td bgcolor="#FF0000" class="navenlace"><a href="#" name="link12" class="Estilo3">Consulta de Suplentes </a></td>
                                                            </tr>
                                                            <tr>
                                                              <td height="29" bgcolor="#FF0000" class="navenlace"><a href="cerrarSesion.php" class="Estilo3">Salir</a></td>
                                                            </tr>
                                                            <tr>
                                                              <td height="5"></td>
                                                            </tr>
