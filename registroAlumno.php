...
<table align="center"  width="600"  >
  ...
  <table width="485" align="center" cellpadding="3">
     ...
     <tr valign="baseline">
       <td colspan="2" align="right" nowrap="nowrap"><div align="center"><em><strong>Registro de Estudiantes </strong></em></div></td>
     </tr>
     <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td colspan="2" align="right" nowrap="nowrap"><div align="left">Cedula:
          <input name="cedula" id="cedula" type="text" value="" size="9" maxlength="8" />
&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;Nombre:
...
<input name="edad" id="edad" type="text" value="" size="2" maxlength="2" />
    ...
    <tr valign="baseline">
      <td colspan="2" align="right" nowrap="nowrap"><div align="left">Repitiente:&nbsp;Si<input name="repitiente" type="radio" value="si">
No<input name="repitiente" type="radio" value="no">
&nbsp;&nbsp;&nbsp;
...
<input name="zapato" type="text" value="" size="5" maxlength="5">
    ...
    <tr valign="baseline">
      <td align="right" nowrap="nowrap" bgcolor="#CCCCCC"><div align="left">Fecha de Naciento:
          <input name="fecha" type="text" class="Estilo6" id="fecha" value="2009-11-09" size="15" readonly>
          <input type="button" value="fecha"  onClick="displayCalendar(document.forms[0].fecha,'yyyy-mm-dd',this)">
      </div></td>
    </tr>
    <tr valign="baseline">
...
&nbsp;
&nbsp;&nbsp;&nbsp;edad
<input name="edadR" type="text" id="edadR" value="" size="2" maxlength="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nacionalidad:
<select name="nacionalidadR" id="nacionalidadR">
  ...
  <option value="Extranjero">Extranjero</option>
    ...
    <tr valign="baseline">
      <td colspan="2" align="right" nowrap bgcolor="#FF0000"><div align="center" class="Estilo7">Ingrese los Datos de la Madre </div></td>
    </tr>
    <tr valign="baseline">
...
&nbsp;
&nbsp;&nbsp;&nbsp;edad
<input name="edadR2" type="text" id="edadR2" value="" size="2" maxlength="3">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nacionalidad:
<select name="nacionalidadR2" id="nacionalidadR2">
  ...
  <input name="ocupacionR2" type="text" value="" size="30" maxlength="50">
    ...
    <tr valign="baseline">
      <td colspan="2" align="right" nowrap bgcolor="#FF0000"><div align="center"><span class="Estilo7">Ingrese los Datos del Representante Legal </span></div></td>
    </tr>
...
<input name="zonav" type="radio" value="Quinta ">
    ...
    <tr valign="baseline">
      <td colspan="2" align="right" nowrap="nowrap"><div align="left">Alguna enfermedad que ha padecido: 
        <input name="enfer2" type="text" value="" size="50" maxlength="50">
      </div></td>
    </tr>
    <tr valign="baseline">
